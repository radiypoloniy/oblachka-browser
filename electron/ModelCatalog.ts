...
// 0.5 ГБ — подобрано по замерам (см. живую проверку при введении константы), не теоретический
// расчёт, поэтому именованная константа, а не магическое число внутри формулы.
const SYSTEM_RESERVE_BYTES = 0.5 * 1024 ** 3 // 536 870 912
