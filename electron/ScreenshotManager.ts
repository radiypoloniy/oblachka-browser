...
// ⚠️ Бумага, не альфа: Windows кладёт картинку ещё и как DIB без прозрачности, и пустое поле
// вокруг тени становилось чёрным в Telegram, Word, Outlook. Цвет бумаги не следует теме окна.
//
...
function ensureIpcRegistered(): void {
  ...
  // ⚠️ В буфер уходит тот же оформленный кадр, что и в файл. Подложка непрозрачная (бумага),
  // поэтому DIB без альфы больше не превращает поле вокруг тени в чёрный прямоугольник.
