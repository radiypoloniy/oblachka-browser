...
// Потолок окна контекста (см. createContext ниже). Считан от самого большого выхода в
// приложении — батча перевода страницы, — с четырёхкратным запасом на вход.
const CONTEXT_MAX_TOKENS = 16384
