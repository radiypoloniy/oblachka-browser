...
const api: OblakoApi = {
  ...
  buildGenWidget: (phrase: string)            => ipcRenderer.invoke(IPC.DESKTOP_GEN_SPEC, phrase) as Promise<GenSpecOutcome>,
