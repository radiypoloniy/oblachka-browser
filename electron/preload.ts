...
const api: OblakoApi = {
  ...
  parseGenWidget: (phrase: string)            => ipcRenderer.invoke(IPC.DESKTOP_GEN_PARSE, phrase) as Promise<GenParseOutcome>,
