...
const FAMILIES = [
  ...
  // ⚠️ Четвёртая гарнитура — ТОЛЬКО ДЛЯ ЧАСОВ, и взята она ради ОСИ ШИРИНЫ (wdth 62..125).
  // Причина конкретная: в растянутой плитке время набирается во всю ширину, и до сих пор это
  // делалось РАСТЯЖЕНИЕМ глифов — буквы плющило, и владелец справедливо сказал «шрифт выглядит
  // не очень». Переменная ось ширины решает это правильно: широкие начертания нарисованы
  // рисовальщиком, а не получены масштабированием. Кириллицы у Archivo нет, и она не нужна —
  // этим шрифтом набираются только цифры и двоеточие.
  { query: 'Archivo:wdth,wght@62..125,400..700', slug: 'archivo', license: 'archivo' },
]
