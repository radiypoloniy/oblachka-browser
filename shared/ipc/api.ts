...
import type { ContentBounds, FindResult, OrganizeCluster, OrganizeProposal, RuleParseOutcome, GenParseOutcome, SearchChipCandidate, SearchChipsConfig, SidebarNode, SpecialTabKind, SyncState, TabState } from './core';
