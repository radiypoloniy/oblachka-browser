...
export const PANELS = {
  ...
  // ── Счёт расхода ─────────────────────────────────────────────────────────
  // ⚠️ Считаем то, что вернул провайдер, а не то, что посчитали сами: прайс-лист внутри браузера
  // устарел бы раньше следующей версии. См. shared/aiUsage.ts.
  AI_USAGE:               'ai:usage',
  AI_USAGE_RESET:         'ai:usage-reset',
