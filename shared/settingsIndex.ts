...
export const SETTINGS_INDEX: SettingsEntry[] = [
  ...
  { section: 'general', block: 'Поиск по умолчанию', label: 'Поиск по умолчанию', sectionLabel: 'Браузер',
    keywords: ['поисковик', 'поисковая система', 'гугл', 'google', 'яндекс', 'yandex', 'duckduckgo', 'адресная строка', 'где искать', 'search engine', 'default search'] },
  ...
  { section: 'general', block: 'Выгрузка вкладок из памяти', label: 'Выгрузка вкладок из памяти', sectionLabel: 'Браузер',
    keywords: ['память', 'озу', 'ram', 'выгрузка', 'усыпление', 'спящие вкладки', 'не выгружать', 'вкладка перезагружается', 'вкладки перезагружаются', 'потребление памяти', 'видео выгружается', 'sleeping tabs', 'unload'] },
  ...
  { section: 'appearance', block: 'Тема', label: 'Тема', sectionLabel: 'Интерфейс',
    keywords: ['тёмная', 'темная', 'светлая', 'dark', 'ночной режим', 'оформление', 'как в системе', 'внешний вид', 'theme', 'appearance', 'light'] },
  { section: 'appearance', block: 'Палитра', label: 'Палитра', sectionLabel: 'Интерфейс',
    keywords: ['оттенок', 'уголь', 'графит', 'сланец', 'бумага', 'мята', 'небо', 'зелёная', 'голубая', 'цвета интерфейса', 'нейтраль'] },
  ...
  { section: 'appearance', block: 'Фон интерфейса', label: 'Фон интерфейса', sectionLabel: 'Интерфейс',
    keywords: ['сайдбар', 'боковая панель', 'цветной фон', 'градиент окна', 'текстура', 'насыщенность', 'создать градиент', 'sidebar', 'window background', 'tint'] },
  { section: 'appearance', block: 'Фон', label: 'Фон новой вкладки', sectionLabel: 'Интерфейс',
    keywords: ['обои', 'картинка', 'изображение', 'wallpaper', 'фото дня', 'заставка', 'градиент', 'сетка', 'mesh'] },
  ...
  { section: 'adblock', label: 'Блокировка рекламы', sectionLabel: 'Блокировка',
    keywords: ['реклама', 'адблок', 'трекеры', 'баннеры', 'исключения', 'белый список', 'не блокировать', 'adblock', 'ads', 'trackers'] },

  // ── AI ────────────────────────────────────────────────────────────────────
  { section: 'ai', block: 'Локальные модели', label: 'Локальная модель', sectionLabel: 'AI',
    keywords: ['модель', 'скачать модель', 'qwen', 'локальный ии', 'нейросеть', 'выгрузить модель', 'видеопамять', '40 минут', 'простой', 'не выгружать модель', 'модель в памяти'] },
  ...
  { section: 'passwords', label: 'Пароли', sectionLabel: 'Пароли',
    keywords: ['сейф', 'vault', 'сохранённые пароли', 'генератор паролей', 'windows hello', 'логин', 'passwords'] },
  { section: 'passwords', block: 'Сохранённые пароли', label: 'Сохранённые пароли', sectionLabel: 'Пароли',
    keywords: ['список паролей', 'добавить пароль', 'показать пароль', 'генератор паролей'] },
  { section: 'passwords', block: 'Перенести из другого браузера', label: 'Перенос из другого браузера', sectionLabel: 'Пароли',
    keywords: ['csv', 'chrome', 'перенести пароли', 'импорт паролей', 'экспорт из браузера'] },
  { section: 'passwords', block: 'Зашифрованная копия сейфа', label: 'Копия сейфа', sectionLabel: 'Пароли',
    keywords: ['бэкап', 'резервная копия', 'экспорт сейфа', 'парольная фраза', 'переустановка'] },
  ...
  // ── Справка ───────────────────────────────────────────────────────────────
  // ⚠️ Три записи, а не одна на каждую функцию. Справка описывает семьдесят с лишним вещей, и
  // высыпать их сюда значило бы утопить в них НАСТОЯЩИЕ настройки: человек ищет «пароли», чтобы
  // попасть в раздел паролей, а не чтобы прочитать про них абзац. Поиск по самой справке живёт
  // внутри раздела отдельной строкой.
  { section: 'help', label: 'Справка: что умеет браузер', sectionLabel: 'Справка',
    keywords: ['справка', 'помощь', 'что умеет', 'возможности', 'функции', 'руководство', 'инструкция', 'как пользоваться', 'help'] },
  { section: 'help', block: 'Горячие клавиши', label: 'Горячие клавиши', sectionLabel: 'Справка',
    keywords: ['клавиши', 'сочетания клавиш', 'хоткеи', 'shortcut', 'ctrl', 'комбинации'] },
  { section: 'help', block: 'Что уходит наружу', label: 'Что уходит наружу, а что нет', sectionLabel: 'Справка',
    keywords: ['приватность', 'телеметрия', 'что отправляется', 'какие данные', 'локально или облако', 'слежка'] },

  // ── Разрешения и правила ──────────────────────────────────────────────────
  { section: 'profiles', block: 'Ваши профили', label: 'Профили', sectionLabel: 'Профили',
    keywords: ['профиль', 'второй аккаунт', 'свои куки', 'личное', 'работа', 'инкогнито профили'] },
  { section: 'profiles', block: 'При запуске браузера', label: 'Профиль при запуске', sectionLabel: 'Профили',
    keywords: ['спрашивать профиль', 'запускаться с профилем', 'стартовый профиль'] },
