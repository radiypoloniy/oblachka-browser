...
// Разделитель между слотами (или между слотом и сеткой, если открыто одно): тянут за него,
// меняется доля высоты. Ручка нарисована полоской по центру — без неё зона в 10 px читается
// как пустой зазор, а не как ручка.
