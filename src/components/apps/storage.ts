...
// ── Размер слотов ────────────────────────────────────────────────────────────────────────────
// Доля высоты ВЕРХНЕГО слота. Когда открыты оба — это граница между ними; когда одно —
// граница между приложением и сеткой иконок. Один ключ: жест тот же, запоминать два числа
// незачем. Границы 0.2…0.8 — не вкусовщина: у слота есть шапка (~36 px), и за пределами вилки
// от приложения остаётся одна шапка, то есть «схлопнул и не понял, куда делось».
