 ...
 *
 * Работает в двух раскладках: два приложения — граница между ними; одно — между карточкой
 * и сеткой иконок. Считается от высоты всей колонки (`slotsRef`), поэтому формула одна.
 *
