 ...
 *
 * ⚠️ Правило «гасить или прятать»: условие про СТРАНИЦУ гасит (тот же приём, что у «Обновить» на
 * хабе), про ОКНО — пряталo бы. Прятать здесь больше нечего: кнопка панели есть и в лёгком окне,
 * там за ней домашний экран приложений без чата (см. electron/aipanel/instances.ts::PanelKind).
 *
