...
/**
 * Адресная строка — ЕДИНСТВЕННОЕ утоплённое место хрома.
 *
 * ⚠️ Выемка, а не плита: поле ввода обязано читаться как углубление, куда кладут текст. Держится
 * светом (тень внутрь плюс светлая кромка снизу), поэтому видна и на цветной земле, и на плоской,
 * и в обеих темах — см. разбор у --inner-well в colors.css.
 */
export function omniWell(): React.CSSProperties {
  return {
