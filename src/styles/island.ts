...
export const chromeTint: React.CSSProperties = {
  backgroundImage:
    ...
    ' color-mix(in srgb, var(--sidebar-tint) 12%, var(--app-bg)) 0%,' +
...
// цветном фоне: та же подкраска, только гуще. Белая заплатка поверх цвета читалась бы вырезанной
// из другой темы. Ставится переменной, а не флагом в пропах: мест много и лежат они в разных
// компонентах, переменная наследуется вниз сама.
export const TINTED_PLATE_VAR = 'color-mix(in srgb, var(--sidebar-tint) 16%, var(--surface))';
