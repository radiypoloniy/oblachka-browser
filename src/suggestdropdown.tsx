...
// ⚠️ Номера строк ПЛОСКИЕ и в режиме панели: сначала «Продолжить», потом плитки, следом карточки
// «уже читали» — ровно тот же массив, что омнибокс держит в suggestions. Вью выводит номер из
// длин panel.resume / panel.sites / panel.recommended и второго источника истины не заводит.
//
